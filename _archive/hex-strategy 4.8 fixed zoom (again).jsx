...
export default function HexStrategyGame(){
  ...
  // When browser pinch-zoom happens at the compositor level (bypassing preventDefault),
  // the visual viewport shrinks. By matching the overlay to it, UI elements stay visible.
  // No transform:scale needed, so no "screen within screen" artifact.
  useEffect(()=>{
