  ...
  if(!gameStarted||!gs){
    ...
    return(<div style={{width:"100vw",minHeight:"100vh",background:"#0a0e06",display:"flex",flexDirection:"column",alignItems:"center",fontFamily:"'Palatino Linotype',serif",overflowY:"auto"}}>
      ...
      <div style={{display:"flex",gap:40}}>
        {playerColumns.map(pid=>{const label=pid==="p1"?(isAiMode?"Your Civilization":"Player 1"):"Player 2";const picked=civPick[pid];
          return(<div key={pid} style={{textAlign:"center"}}>
            <div style={{color:CIV_DEFS[picked]?.colorLight||"#aaa",fontSize:14,letterSpacing:2,marginBottom:8}}>{label}</div>
      ...
      <div style={{display:"flex",gap:16,alignItems:"center"}}>
        ...
        <div onClick={()=>{setMapSizePick(null);}} style={{color:"#6a7a50",fontSize:9,cursor:"pointer",textDecoration:"underline"}}>← Back</div>
      </div>
      </div>
    </div>);
  }
