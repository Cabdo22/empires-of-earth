...
import { hudPanelStyle } from "../styles.js";
...
export function NotificationCircles({ turnPopups, setTurnPopups, setShowTech, setShowCity }) {
  ...
  return (
    <div style={{ position: "absolute", bottom: 226, right: 26, zIndex: 35, pointerEvents: "auto" }}>
      {turnPopups.length > 1 && <div style={{ position: "absolute", top: -8, right: -8, width: 22, height: 22, borderRadius: "50%", background: "#c05050", color: "#fff", fontSize: 11, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 36, border: "1px solid #e07070" }}>{turnPopups.length}</div>}
      <div
        style={{
          ...hudPanelStyle,
