...
export const TECH_TREE = {
  ...
  pottery:        { id: "pottery",        name: "Pottery",        era: "Dawn", phase: 2, cost: 12, prereqs: ["basic_tools", "agriculture", "hunting"], prereqMin: 2, effects: ["+1 gold per city"], row: 1 },
  stone_working:  { id: "stone_working",  name: "Stone Working",  era: "Dawn", phase: 2, cost: 13, prereqs: ["basic_tools", "agriculture", "hunting"], prereqMin: 2, effects: ["+5 city max HP"], row: 2 },
  ...
  space_program:     { id: "space_program",     name: "Space Program",     era: "Future", phase: 2, cost: 127, prereqs: ["quantum_computing", "ai_governance", "nanotech"], prereqMin: 2, effects: ["+4 sci, Victory"], row: 1 },
  cybernetics:       { id: "cybernetics",       name: "Cybernetics",       era: "Future", phase: 2, cost: 116, prereqs: ["quantum_computing", "ai_governance", "nanotech"], prereqMin: 2, effects: ["+2 all unit str"], row: 2 },
};
