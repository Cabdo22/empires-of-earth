...
export const UNIT_DEFS = {
  // ── Non-combat ──
  scout:            { name: "Scout",            icon: "👁",    strength: 1, hp: 10, move: 3, range: 0, cost: 6,   techReq: null,               domain: "land" },
  settler:          { name: "Settler",          icon: "🏕",    strength: 0, hp: 10, move: 2, range: 0, cost: 14,  techReq: null,               domain: "land" },

  // ── Infantry line ──
  warrior:          { name: "Warrior",          icon: "🛡",    strength: 2, hp: 15, move: 2, range: 0, cost: 7,   techReq: null,               domain: "land" },
  swordsman:        { name: "Swordsman",        icon: "⚔",    strength: 4, hp: 20, move: 2, range: 0, cost: 11,  techReq: "bronze_working",   domain: "land", resourceReq: "iron" },
  man_at_arms:      { name: "Man-at-Arms",      icon: "⚔",    strength: 5, hp: 22, move: 2, range: 0, cost: 13,  techReq: "steelworking",     domain: "land", resourceReq: "iron" },
  musketman:        { name: "Musketman",        icon: "🔫",    strength: 6, hp: 28, move: 2, range: 0, cost: 18,  techReq: "gunpowder",        domain: "land" },
  modern_infantry:  { name: "Modern Infantry",  icon: "🎖",    strength: 7, hp: 32, move: 2, range: 0, cost: 21,  techReq: "logistics",        domain: "amphibious" },
  ...
  caravel:          { name: "Caravel",          icon: "⛵",    strength: 3, hp: 18, move: 3, range: 0, cost: 12,  techReq: "forestry",         domain: "sea" },
  frigate:          { name: "Frigate",          icon: "🚢",    strength: 4, hp: 22, move: 4, range: 0, cost: 16,  techReq: "steam_power",      domain: "sea", resourceReq: "oil" },
  ...
  icbm:             { name: "ICBM",             icon: "☢",    strength: 99, hp: 1, move: 0, range: 20, cost: 48, techReq: "quantum_computing", domain: "special", resourceReq: "uranium" },
