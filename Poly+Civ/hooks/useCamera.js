...
import { TILE_SIZE, ISO_HW, ISO_HH, COLS, ROWS, hexAt } from '../data/constants.js';
...
export function useCamera({ hexes, gs, players, fogVisible, fogExplored }) {
  ...
  const wW = (COLS + ROWS + 1) * ISO_HW + 100;
  const wH = (COLS + ROWS + 1) * ISO_HH + 140;
